...
set C_modelArgList {
	{ data_V_read int 12544 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data_V_read", "interface" : "wire", "bitwidth" : 12544, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ data_V_read sc_in sc_lv 12544 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":12544, "type": "signal", "bundle":{"name": "data_V_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_mux_1007_16_1_1_U1", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_mux_1007_16_1_1_U2", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_mux_1007_16_1_1_U3", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "396324", "Max" : "396324"}
	, {"Name" : "Interval", "Min" : "396324", "Max" : "396324"}
]}
...
set Spec2ImplPortList { 
	data_V_read { ap_none {  { data_V_read in_data 0 12544 } } }
}
