...
wire   [31:0] tmp_58_fu_817_p1;
reg   [31:0] tmp_58_reg_1164;
wire    ap_CS_fsm_state81;
wire   [63:0] i_18_fu_830_p2;
reg   [63:0] i_18_reg_1177;
wire    ap_CS_fsm_state83;
wire   [17:0] tmp_59_fu_836_p1;
reg   [17:0] tmp_59_reg_1182;
...
wire   [2:0] tmp_57_fu_711_p1;
wire  signed [31:0] i_19_cast_fu_903_p1;
wire   [17:0] tmp_62_fu_961_p1;
...
vlsiModel_udiv_20jbC #(
    .ID( 1 ),
    .NUM_STAGE( 24 ),
    .din0_WIDTH( 20 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
vlsiModel_udiv_20jbC_U22(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((tmp_8_fu_642_p2 == 1'd0) & (exitcond_fu_631_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond3_fu_825_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state83))) begin
        i_0_in_i_reg_538 <= tmp_58_reg_1164;
...
always @ (posedge ap_clk) begin
    if (((tmp_60_fu_845_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state84))) begin
        j_4_reg_547 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_61_fu_907_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state158))) begin
        j_5_reg_590 <= 2'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_61_fu_907_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state158))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond9_fu_805_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state80))) begin
        tmp_58_reg_1164 <= tmp_58_fu_817_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond3_fu_825_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state83))) begin
        tmp_59_reg_1182 <= tmp_59_fu_836_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_60_fu_845_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state84))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state230)) begin
        ...
        dense_fwork_address0 = grp_k2c_matmul_fu_601_A_address0;
    end else begin
...
always @ (*) begin
    if ((((grp_k2c_sub2idx_fu_613_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state230)) | ((grp_k2c_sub2idx_fu_613_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state156)))) begin
        ...
        dense_fwork_ce0 = grp_k2c_matmul_fu_601_A_ce0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state231)) begin
        dense_fwork_ce1 = grp_k2c_matmul_fu_601_A_ce1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state230)) begin
        dense_fwork_d0 = dense_kernel_array_q0;
    end else if ((1'b1 == ap_CS_fsm_state156)) begin
...
assign dense_kernel_array_address0 = idx2_3_cast2_reg_1244;
...
assign i_2_cast_fu_719_p2 = ($signed(3'd7) + $signed(tmp_57_fu_711_p1));
...
assign sum_fu_965_p2 = (tmp_62_fu_961_p1 + tmp_59_reg_1182);

assign tmp_57_fu_711_p1 = A_ndim_read[2:0];

assign tmp_58_fu_817_p1 = A_ndim_read[31:0];

assign tmp_59_fu_836_p1 = A_numel_read[17:0];

assign tmp_60_fu_845_p3 = i_15_fu_839_p2[32'd31];

assign tmp_61_fu_907_p3 = i_16_reg_579[32'd1];

assign tmp_62_fu_961_p1 = grp_k2c_sub2idx_fu_613_ap_return[17:0];

assign tmp_6_i5_fu_915_p1 = $unsigned(i_19_cast_fu_903_p1);

assign tmp_6_i_fu_853_p1 = i_15_fu_839_p2;

assign tmp_8_fu_642_p2 = ((i_reg_426 == p_read4) ? 1'b1 : 1'b0);
