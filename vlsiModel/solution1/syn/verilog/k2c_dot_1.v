...
wire   [4:0] grp_k2c_matmul_2_fu_595_C_address0;
wire    grp_k2c_matmul_2_fu_595_C_ce0;
wire    grp_k2c_matmul_2_fu_595_C_we0;
wire   [31:0] grp_k2c_matmul_2_fu_595_C_d0;
wire   [10:0] grp_k2c_matmul_2_fu_595_A_address0;
wire    grp_k2c_matmul_2_fu_595_A_ce0;
wire   [10:0] grp_k2c_matmul_2_fu_595_A_address1;
wire    grp_k2c_matmul_2_fu_595_A_ce1;
...
wire   [2:0] tmp_70_fu_702_p1;
wire   [11:0] tmp_76_fu_928_p1;
...
dense_2_fwork_U(
    ...
    .d0(dense_2_fwork_d0),
    .q0(dense_2_fwork_q0),
    .address1(grp_k2c_matmul_2_fu_595_A_address1),
    .ce1(dense_2_fwork_ce1),
    .q1(dense_2_fwork_q1)
);

k2c_dot_1_dense_2yd2 #(
    .DataWidth( 32 ),
    .AddressRange( 1250 ),
    .AddressWidth( 11 ))
...
k2c_matmul_2 grp_k2c_matmul_2_fu_595(
    ...
    .C_q0(C_array_q0),
    .A_address0(grp_k2c_matmul_2_fu_595_A_address0),
    .A_ce0(grp_k2c_matmul_2_fu_595_A_ce0),
    .A_q0(dense_2_fwork_q0),
    .A_address1(grp_k2c_matmul_2_fu_595_A_address1),
    .A_ce1(grp_k2c_matmul_2_fu_595_A_ce1),
    .A_q1(dense_2_fwork_q1),
...
always @ (posedge ap_clk) begin
    if (((exitcond2_fu_869_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state157))) begin
        i_0_in_i3_reg_575 <= tmp_72_reg_1165;
...
always @ (posedge ap_clk) begin
    if (((exitcond5_fu_804_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state83))) begin
        i_0_in_i_reg_531 <= tmp_71_reg_1147;
...
always @ (posedge ap_clk) begin
    if (((tmp_74_fu_827_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state84))) begin
        j_4_reg_540 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_75_fu_886_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state158))) begin
        j_5_reg_584 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_75_fu_886_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state158))) begin
        tmp_6_i6_reg_1248[31 : 0] <= tmp_6_i6_fu_894_p1[31 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_74_fu_827_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state84))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond9_fu_790_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state80))) begin
        tmp_71_reg_1147 <= tmp_71_fu_801_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond5_fu_804_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state83))) begin
        tmp_72_reg_1165 <= tmp_72_fu_815_p1;
        tmp_73_reg_1170 <= tmp_73_fu_818_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state230)) begin
        ...
        dense_2_fwork_address0 = grp_k2c_matmul_2_fu_595_A_address0;
    end else begin
...
always @ (*) begin
    if ((((grp_k2c_sub2idx_fu_607_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state230)) | ((grp_k2c_sub2idx_fu_607_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state156)))) begin
        ...
        dense_2_fwork_ce0 = grp_k2c_matmul_2_fu_595_A_ce0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state231)) begin
        dense_2_fwork_ce1 = grp_k2c_matmul_2_fu_595_A_ce1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state230)) begin
        dense_2_fwork_d0 = dense_2_kernel_array_q0;
    end else if ((1'b1 == ap_CS_fsm_state156)) begin
...
assign dense_2_kernel_array_address0 = idx2_9_reg_551;
...
assign i_14_cast_fu_710_p2 = ($signed(3'd7) + $signed(tmp_70_fu_702_p1));
...
assign sum_fu_932_p2 = (tmp_76_fu_928_p1 + tmp_73_reg_1170);

assign tmp_3_fu_752_p2 = ((i_7_cast_fu_748_p1 < B_ndim_read) ? 1'b1 : 1'b0);

assign tmp_6_i6_fu_894_p1 = i_24_fu_880_p2;

assign tmp_6_i_fu_835_p1 = i_23_fu_821_p2;

assign tmp_70_fu_702_p1 = A_ndim_read[2:0];

assign tmp_71_fu_801_p1 = A_ndim_read[31:0];

assign tmp_72_fu_815_p1 = B_ndim_read[31:0];

assign tmp_73_fu_818_p1 = A_numel_read[11:0];

assign tmp_74_fu_827_p3 = i_23_fu_821_p2[32'd31];

assign tmp_75_fu_886_p3 = i_24_fu_880_p2[32'd31];

assign tmp_76_fu_928_p1 = grp_k2c_sub2idx_fu_607_ap_return[11:0];

assign tmp_8_fu_635_p2 = ((i_reg_418 == p_read4) ? 1'b1 : 1'b0);
