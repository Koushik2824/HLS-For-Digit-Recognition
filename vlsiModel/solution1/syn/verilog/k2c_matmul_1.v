...
wire   [3:0] a10_fu_163_p2;
wire    ap_CS_fsm_state3;
wire  signed [4:0] tmp_39_fu_169_p1;
reg  signed [4:0] tmp_39_reg_318;
wire   [0:0] exitcond3_fu_158_p2;
wire  signed [9:0] tmp_40_fu_172_p1;
reg  signed [9:0] tmp_40_reg_323;
wire  signed [9:0] tmp_41_fu_175_p1;
reg  signed [9:0] tmp_41_reg_328;
wire   [9:0] tmp_42_fu_178_p1;
reg   [9:0] tmp_42_reg_333;
wire   [63:0] i_4_fu_194_p2;
reg   [63:0] i_4_reg_341;
wire    ap_CS_fsm_state4;
wire   [4:0] outrowidx_fu_200_p2;
reg   [4:0] outrowidx_reg_346;
wire   [0:0] exitcond2_fu_189_p2;
wire  signed [9:0] inneridx_fu_269_p2;
reg  signed [9:0] inneridx_reg_351;
wire   [63:0] k_2_fu_214_p2;
reg   [63:0] k_2_reg_359;
wire    ap_CS_fsm_state5;
reg   [8:0] B_addr_reg_364;
wire   [0:0] exitcond1_fu_209_p2;
wire  signed [9:0] grp_fu_274_p3;
reg  signed [9:0] tmp1_reg_369;
wire   [63:0] j_2_fu_243_p2;
reg   [63:0] j_2_reg_377;
wire    ap_CS_fsm_state6;
wire   [0:0] exitcond_fu_238_p2;
reg   [3:0] C_addr_3_reg_387;
reg   [31:0] B_load_3_reg_392;
...
wire  signed [63:0] tmp_39_fu_169_p0;
wire  signed [63:0] tmp_41_fu_175_p0;
wire  signed [63:0] exitcond2_fu_189_p1;
wire  signed [4:0] tmp_44_fu_185_p1;
wire  signed [9:0] tmp_45_fu_205_p1;
(* use_dsp48 = "no" *) wire   [9:0] sum_fu_220_p2;
wire  signed [63:0] exitcond_fu_238_p1;
wire   [9:0] tmp_47_fu_234_p1;
(* use_dsp48 = "no" *) wire   [9:0] sum3_fu_249_p2;
wire   [4:0] tmp_46_fu_230_p1;
wire   [4:0] sum2_fu_259_p2;
wire  signed [9:0] inneridx_fu_269_p0;
reg   [14:0] ap_NS_fsm;
...
vlsiModel_mul_mulBew #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 10 ),
    .din1_WIDTH( 10 ),
    .dout_WIDTH( 10 ))
vlsiModel_mul_mulBew_U187(
    .din0(inneridx_fu_269_p0),
    .din1(tmp_40_reg_323),
    .dout(inneridx_fu_269_p2)
);

vlsiModel_mac_mulCeG #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 10 ),
    .din1_WIDTH( 10 ),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (exitcond_fu_238_p2 == 1'd0))) begin
        C_addr_3_reg_387 <= sum2_cast_fu_264_p1;
    end
end
...
assign a10_fu_163_p2 = (a_reg_93 + 4'd1);
...
assign inneridx_fu_269_p0 = i_reg_104[9:0];

assign j_2_fu_243_p2 = (64'd1 + j_reg_126);

assign k_2_fu_214_p2 = (64'd1 + k_reg_115);

assign outrowidx_fu_200_p2 = ($signed(tmp_44_fu_185_p1) * $signed(tmp_39_reg_318));

assign sum2_cast_fu_264_p1 = sum2_fu_259_p2;

assign sum2_fu_259_p2 = (tmp_46_fu_230_p1 + outrowidx_reg_346);

assign sum3_cast_fu_254_p1 = sum3_fu_249_p2;

assign sum3_fu_249_p2 = ($signed(tmp1_reg_369) + $signed(tmp_47_fu_234_p1));

assign sum_cast_fu_225_p1 = sum_fu_220_p2;

assign sum_fu_220_p2 = ($signed(tmp_45_fu_205_p1) + $signed(inneridx_reg_351));

assign tmp_39_fu_169_p0 = outcols;

assign tmp_39_fu_169_p1 = tmp_39_fu_169_p0[4:0];

assign tmp_40_fu_172_p1 = innerdim[9:0];

assign tmp_41_fu_175_p0 = outcols;

assign tmp_41_fu_175_p1 = tmp_41_fu_175_p0[9:0];

assign tmp_42_fu_178_p1 = B_offset[9:0];

assign tmp_44_fu_185_p1 = i_reg_104[4:0];

assign tmp_45_fu_205_p1 = k_reg_115[9:0];

assign tmp_46_fu_230_p1 = j_reg_126[4:0];

assign tmp_47_fu_234_p1 = j_reg_126[9:0];
