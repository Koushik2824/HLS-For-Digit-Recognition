...
reg   [63:0] Bsub_d0;
wire   [63:0] Bsub_q0;
wire    grp_k2c_matmul_3_fu_595_ap_start;
wire    grp_k2c_matmul_3_fu_595_ap_done;
wire    grp_k2c_matmul_3_fu_595_ap_idle;
wire    grp_k2c_matmul_3_fu_595_ap_ready;
wire   [5:0] grp_k2c_matmul_3_fu_595_C_address0;
wire    grp_k2c_matmul_3_fu_595_C_ce0;
wire    grp_k2c_matmul_3_fu_595_C_we0;
wire   [31:0] grp_k2c_matmul_3_fu_595_C_d0;
wire   [12:0] grp_k2c_matmul_3_fu_595_A_address0;
wire    grp_k2c_matmul_3_fu_595_A_ce0;
wire   [12:0] grp_k2c_matmul_3_fu_595_A_address1;
wire    grp_k2c_matmul_3_fu_595_A_ce1;
...
reg    grp_k2c_matmul_3_fu_595_ap_start_reg;
...
wire   [2:0] tmp_77_fu_702_p1;
wire   [13:0] tmp_83_fu_928_p1;
...
initial begin
#0 ap_CS_fsm = 231'd1;
#0 grp_k2c_matmul_3_fu_595_ap_start_reg = 1'b0;
#0 grp_k2c_sub2idx_fu_607_ap_start_reg = 1'b0;
end

k2c_dot_dense_1_frcU #(
    .DataWidth( 32 ),
    .AddressRange( 5100 ),
    .AddressWidth( 13 ))
dense_1_fwork_U(
    ...
    .d0(dense_1_fwork_d0),
    .q0(dense_1_fwork_q0),
    .address1(grp_k2c_matmul_3_fu_595_A_address1),
    .ce1(dense_1_fwork_ce1),
    .q1(dense_1_fwork_q1)
);

k2c_dot_dense_1_ksc4 #(
    .DataWidth( 32 ),
    .AddressRange( 5000 ),
    .AddressWidth( 13 ))
...
k2c_matmul_3 grp_k2c_matmul_3_fu_595(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_k2c_matmul_3_fu_595_ap_start),
    .ap_done(grp_k2c_matmul_3_fu_595_ap_done),
    .ap_idle(grp_k2c_matmul_3_fu_595_ap_idle),
    .ap_ready(grp_k2c_matmul_3_fu_595_ap_ready),
    .C_address0(grp_k2c_matmul_3_fu_595_C_address0),
    .C_ce0(grp_k2c_matmul_3_fu_595_C_ce0),
    .C_we0(grp_k2c_matmul_3_fu_595_C_we0),
    .C_d0(grp_k2c_matmul_3_fu_595_C_d0),
    .C_q0(C_array_q0),
    .A_address0(grp_k2c_matmul_3_fu_595_A_address0),
    .A_ce0(grp_k2c_matmul_3_fu_595_A_ce0),
    .A_q0(dense_1_fwork_q0),
    .A_address1(grp_k2c_matmul_3_fu_595_A_address1),
    .A_ce1(grp_k2c_matmul_3_fu_595_A_ce1),
...
vlsiModel_udiv_64ibs #(
    .ID( 1 ),
    .NUM_STAGE( 68 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
vlsiModel_udiv_64ibs_U81(
    .clk(ap_clk),
    .reset(ap_rst),
...
vlsiModel_urem_64kbM #(
    .ID( 1 ),
    .NUM_STAGE( 68 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
vlsiModel_urem_64kbM_U83(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_k2c_matmul_3_fu_595_ap_start_reg <= 1'b0;
    end else begin
        if (((exitcond5_fu_869_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state157))) begin
            grp_k2c_matmul_3_fu_595_ap_start_reg <= 1'b1;
        end else if ((grp_k2c_matmul_3_fu_595_ap_ready == 1'b1)) begin
            grp_k2c_matmul_3_fu_595_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_8_fu_635_p2 == 1'd0) & (exitcond_fu_624_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond5_fu_869_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state157))) begin
        i_0_in_i3_reg_575 <= tmp_79_reg_1165;
...
always @ (posedge ap_clk) begin
    if (((exitcond4_fu_804_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state83))) begin
        i_0_in_i_reg_531 <= tmp_78_reg_1147;
...
always @ (posedge ap_clk) begin
    if (((tmp_4_fu_752_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state75))) begin
        i_8_reg_485 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_81_fu_827_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state84))) begin
        j_4_reg_540 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_82_fu_886_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state158))) begin
        j_5_reg_584 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_4_fu_752_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state75))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_82_fu_886_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state158))) begin
        tmp_6_i6_reg_1248[31 : 0] <= tmp_6_i6_fu_894_p1[31 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_81_fu_827_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state84))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond9_fu_790_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state80))) begin
        tmp_78_reg_1147 <= tmp_78_fu_801_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond4_fu_804_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state83))) begin
        tmp_79_reg_1165 <= tmp_79_fu_815_p1;
        tmp_80_reg_1170 <= tmp_80_fu_818_p1;
    end
end
...
always @ (*) begin
    if ((((grp_k2c_matmul_3_fu_595_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state231)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((grp_k2c_matmul_3_fu_595_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state231))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state230)) begin
        ...
        dense_1_fwork_address0 = grp_k2c_matmul_3_fu_595_A_address0;
    end else begin
...
always @ (*) begin
    if ((((grp_k2c_sub2idx_fu_607_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state230)) | ((grp_k2c_sub2idx_fu_607_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state156)))) begin
        ...
        dense_1_fwork_ce0 = grp_k2c_matmul_3_fu_595_A_ce0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state231)) begin
        dense_1_fwork_ce1 = grp_k2c_matmul_3_fu_595_A_ce1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state230)) begin
        dense_1_fwork_d0 = dense_1_kernel_array_q0;
    end else if ((1'b1 == ap_CS_fsm_state156)) begin
...
assign C_array_address0 = grp_k2c_matmul_3_fu_595_C_address0;

assign C_array_ce0 = grp_k2c_matmul_3_fu_595_C_ce0;

assign C_array_d0 = grp_k2c_matmul_3_fu_595_C_d0;

assign C_array_we0 = grp_k2c_matmul_3_fu_595_C_we0;
...
assign dense_1_kernel_array_address0 = idx2_11_reg_551;
...
assign grp_k2c_matmul_3_fu_595_ap_start = grp_k2c_matmul_3_fu_595_ap_start_reg;

assign grp_k2c_sub2idx_fu_607_ap_start = grp_k2c_sub2idx_fu_607_ap_start_reg;

assign i_14_cast_fu_710_p2 = ($signed(3'd7) + $signed(tmp_77_fu_702_p1));
...
assign sum_fu_932_p2 = (tmp_83_fu_928_p1 + tmp_80_reg_1170);

assign tmp_4_fu_752_p2 = ((i_7_cast_fu_748_p1 < B_ndim_read) ? 1'b1 : 1'b0);

assign tmp_6_i6_fu_894_p1 = i_27_fu_880_p2;

assign tmp_6_i_fu_835_p1 = i_26_fu_821_p2;

assign tmp_77_fu_702_p1 = A_ndim_read[2:0];

assign tmp_78_fu_801_p1 = A_ndim_read[31:0];

assign tmp_79_fu_815_p1 = B_ndim_read[31:0];

assign tmp_80_fu_818_p1 = A_numel_read[13:0];

assign tmp_81_fu_827_p3 = i_26_fu_821_p2[32'd31];

assign tmp_82_fu_886_p3 = i_27_fu_880_p2[32'd31];

assign tmp_83_fu_928_p1 = grp_k2c_sub2idx_fu_607_ap_return[13:0];

assign tmp_8_fu_635_p2 = ((i_reg_418 == axesA_0_read) ? 1'b1 : 1'b0);
