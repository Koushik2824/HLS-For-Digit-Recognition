...
wire   [0:0] tmp_11_fu_54_p2;
reg   [0:0] tmp_11_reg_138;
reg   [63:0] i_reg_42;
wire    ap_CS_fsm_state4;
wire   [0:0] tmp_12_fu_105_p2;
wire   [31:0] x_load_to_int_fu_71_p1;
wire   [7:0] tmp_fu_75_p4;
wire   [22:0] tmp_6_fu_85_p1;
...
always @ (*) begin
    if (((tmp_12_fu_105_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        x_we0 = 1'b1;
    end else begin
        x_we0 = 1'b0;
    end
...
assign notrhs_fu_95_p2 = ((tmp_6_fu_85_p1 == 23'd0) ? 1'b1 : 1'b0);

assign tmp_12_fu_105_p2 = (tmp_s_fu_101_p2 & tmp_11_reg_138);

assign tmp_6_fu_85_p1 = x_load_to_int_fu_71_p1[22:0];
