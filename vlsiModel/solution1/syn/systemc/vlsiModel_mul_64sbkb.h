...
#ifndef __vlsiModel_mul_64sbkb__HH__
#define __vlsiModel_mul_64sbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mul_64sbkb) {
    ...
    SC_CTOR(vlsiModel_mul_64sbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
