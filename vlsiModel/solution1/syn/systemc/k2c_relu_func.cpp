...
k2c_relu_func::k2c_relu_func(sc_module_name name) : sc_module(name), mVcdFile(0) {
    vlsiModel_fcmp_32kbM_U42 = new vlsiModel_fcmp_32kbM<1,1,32,32,1>("vlsiModel_fcmp_32kbM_U42");
    vlsiModel_fcmp_32kbM_U42->din0(x_q0);
    vlsiModel_fcmp_32kbM_U42->din1(ap_var_for_const0);
    vlsiModel_fcmp_32kbM_U42->opcode(ap_var_for_const1);
    vlsiModel_fcmp_32kbM_U42->dout(tmp_11_fu_54_p2);
    ...
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( tmp_6_fu_85_p1 );

    SC_METHOD(thread_tmp_12_fu_105_p2);
    sensitive << ( tmp_11_reg_138 );
    sensitive << ( tmp_s_fu_101_p2 );

    SC_METHOD(thread_tmp_6_fu_85_p1);
    ...
    sc_trace(mVcdFile, tmp_11_fu_54_p2, "tmp_11_fu_54_p2");
    sc_trace(mVcdFile, tmp_11_reg_138, "tmp_11_reg_138");
    sc_trace(mVcdFile, i_reg_42, "i_reg_42");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, tmp_12_fu_105_p2, "tmp_12_fu_105_p2");
    sc_trace(mVcdFile, x_load_to_int_fu_71_p1, "x_load_to_int_fu_71_p1");
    sc_trace(mVcdFile, tmp_fu_75_p4, "tmp_fu_75_p4");
    sc_trace(mVcdFile, tmp_6_fu_85_p1, "tmp_6_fu_85_p1");
...
k2c_relu_func::~k2c_relu_func() {
    ...
    delete vlsiModel_fcmp_32kbM_U42;
}
...
void k2c_relu_func::thread_i_3_fu_65_p2() {
...
void k2c_relu_func::thread_notrhs_fu_95_p2() {
    notrhs_fu_95_p2 = (!tmp_6_fu_85_p1.read().is_01() || !ap_const_lv23_0.is_01())? sc_lv<1>(): sc_lv<1>(tmp_6_fu_85_p1.read() == ap_const_lv23_0);
}

void k2c_relu_func::thread_tmp_12_fu_105_p2() {
    tmp_12_fu_105_p2 = (tmp_s_fu_101_p2.read() & tmp_11_reg_138.read());
}

void k2c_relu_func::thread_tmp_6_fu_85_p1() {
    tmp_6_fu_85_p1 = x_load_to_int_fu_71_p1.read().range(23-1, 0);
}
...
void k2c_relu_func::thread_tmp_s_fu_101_p2() {
...
void k2c_relu_func::thread_x_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        ...
        x_address0 =  (sc_lv<17>) (i_reg_42.read());
    } else {
...
void k2c_relu_func::thread_x_we0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
         esl_seteq<1,1,1>(tmp_12_fu_105_p2.read(), ap_const_lv1_1))) {
