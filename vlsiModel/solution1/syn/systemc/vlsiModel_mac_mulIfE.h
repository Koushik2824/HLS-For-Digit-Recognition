...
#ifndef __vlsiModel_mac_mulIfE__HH__
#define __vlsiModel_mac_mulIfE__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mac_mulIfE) {
    ...
    SC_CTOR(vlsiModel_mac_mulIfE):  simcore_mac_4_U ("simcore_mac_4_U") {
