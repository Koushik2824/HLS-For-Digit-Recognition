...
#ifndef __vlsiModel_udiv_20jbC__HH__
#define __vlsiModel_udiv_20jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_udiv_20jbC) {
    ...
    ACMP_udiv_seq<ID, 24, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_udiv_seq_U;

    SC_CTOR(vlsiModel_udiv_20jbC):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
