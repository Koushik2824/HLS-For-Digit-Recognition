...
#ifndef __vlsiModel_dense_1Ffa_H__
#define __vlsiModel_dense_1Ffa_H__
...
struct vlsiModel_dense_1Ffa_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(vlsiModel_dense_1Ffa_ram) {
...
SC_MODULE(vlsiModel_dense_1Ffa) {
...
vlsiModel_dense_1Ffa_ram* meminst;


SC_CTOR(vlsiModel_dense_1Ffa) {
meminst = new vlsiModel_dense_1Ffa_ram("vlsiModel_dense_1Ffa_ram");
