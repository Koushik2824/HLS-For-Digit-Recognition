...
#ifndef __vlsiModel_mul_mullbW__HH__
#define __vlsiModel_mul_mullbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mul_mullbW) {
    ...
    SC_CTOR(vlsiModel_mul_mullbW):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
