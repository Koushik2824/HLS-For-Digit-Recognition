...
#ifndef __vlsiModel_mac_mulpcA__HH__
#define __vlsiModel_mac_mulpcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mac_mulpcA) {
    ...
    SC_CTOR(vlsiModel_mac_mulpcA):  simcore_mac_2_U ("simcore_mac_2_U") {
