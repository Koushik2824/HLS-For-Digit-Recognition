...
#ifndef __vlsiModel_urem_64kbM__HH__
#define __vlsiModel_urem_64kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_urem_64kbM) {
    ...
    SC_CTOR(vlsiModel_urem_64kbM):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
