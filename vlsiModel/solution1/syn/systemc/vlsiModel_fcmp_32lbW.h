...
#ifndef __vlsiModel_fcmp_32lbW__HH__
#define __vlsiModel_fcmp_32lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_fcmp_32lbW) {
    ...
    SC_CTOR(vlsiModel_fcmp_32lbW):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
