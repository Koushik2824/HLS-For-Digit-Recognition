...
#ifndef __vlsiModel_mul_mulmb6__HH__
#define __vlsiModel_mul_mulmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mul_mulmb6) {
    ...
    SC_CTOR(vlsiModel_mul_mulmb6):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
