...
#ifndef __vlsiModel_fcmp_32kbM__HH__
#define __vlsiModel_fcmp_32kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_fcmp_32kbM) {
    ...
    SC_CTOR(vlsiModel_fcmp_32kbM):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
