...
#ifndef __vlsiModel_mac_mulmb6__HH__
#define __vlsiModel_mac_mulmb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mac_mulmb6) {
    ...
    SC_CTOR(vlsiModel_mac_mulmb6):  simcore_mac_1_U ("simcore_mac_1_U") {
