...
#ifndef __vlsiModel_mac_mulfYi__HH__
#define __vlsiModel_mac_mulfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mac_mulfYi) {
    ...
    SC_CTOR(vlsiModel_mac_mulfYi):  simcore_mac_0_U ("simcore_mac_0_U") {
