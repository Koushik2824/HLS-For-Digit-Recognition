...
#ifndef __vlsiModel_mac_mulwdI__HH__
#define __vlsiModel_mac_mulwdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mac_mulwdI) {
    ...
    SC_CTOR(vlsiModel_mac_mulwdI):  simcore_mac_2_U ("simcore_mac_2_U") {
