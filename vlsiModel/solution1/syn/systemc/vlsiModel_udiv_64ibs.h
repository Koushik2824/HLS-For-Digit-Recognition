...
#ifndef __vlsiModel_udiv_64ibs__HH__
#define __vlsiModel_udiv_64ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_udiv_64ibs) {
    ...
    SC_CTOR(vlsiModel_udiv_64ibs):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
