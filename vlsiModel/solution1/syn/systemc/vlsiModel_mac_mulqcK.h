...
#ifndef __vlsiModel_mac_mulqcK__HH__
#define __vlsiModel_mac_mulqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mac_mulqcK) {
    ...
    SC_CTOR(vlsiModel_mac_mulqcK):  simcore_mac_1_U ("simcore_mac_1_U") {
