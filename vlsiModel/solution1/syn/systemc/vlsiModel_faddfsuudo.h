...
#ifndef __vlsiModel_faddfsuudo__HH__
#define __vlsiModel_faddfsuudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_faddfsuudo) {
    ...
    SC_CTOR(vlsiModel_faddfsuudo):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
