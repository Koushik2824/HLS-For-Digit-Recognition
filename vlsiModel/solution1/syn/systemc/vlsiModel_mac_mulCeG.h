...
#ifndef __vlsiModel_mac_mulCeG__HH__
#define __vlsiModel_mac_mulCeG__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mac_mulCeG) {
    ...
    SC_CTOR(vlsiModel_mac_mulCeG):  simcore_mac_3_U ("simcore_mac_3_U") {
