...
#ifndef __vlsiModel_mul_muleOg__HH__
#define __vlsiModel_mul_muleOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mul_muleOg) {
    ...
    SC_CTOR(vlsiModel_mul_muleOg):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
