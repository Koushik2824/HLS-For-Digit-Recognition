...
#ifndef __vlsiModel_udiv_64hbi__HH__
#define __vlsiModel_udiv_64hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_udiv_64hbi) {
    ...
    SC_CTOR(vlsiModel_udiv_64hbi):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
