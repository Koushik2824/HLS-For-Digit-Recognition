...
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state1 = "1";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state2 = "10";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state3 = "100";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state4 = "1000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state5 = "10000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state6 = "100000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state7 = "1000000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state8 = "10000000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state9 = "100000000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state10 = "1000000000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state11 = "10000000000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state12 = "100000000000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state13 = "1000000000000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state14 = "10000000000000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state15 = "100000000000000";
const sc_lv<16> k2c_matmul_1::ap_ST_fsm_state16 = "1000000000000000";
...
const sc_lv<17> k2c_matmul_1::ap_const_lv17_0 = "00000000000000000";
...
const sc_lv<17> k2c_matmul_1::ap_const_lv17_1 = "1";
...
k2c_matmul_1::k2c_matmul_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    vlsiModel_fadd_32cud_U114 = new vlsiModel_fadd_32cud<1,5,32,32,32>("vlsiModel_fadd_32cud_U114");
    vlsiModel_fadd_32cud_U114->clk(ap_clk);
    vlsiModel_fadd_32cud_U114->reset(ap_rst);
    vlsiModel_fadd_32cud_U114->din0(C_load_reg_405);
    vlsiModel_fadd_32cud_U114->din1(tmp_1_reg_400);
    vlsiModel_fadd_32cud_U114->ce(ap_var_for_const0);
    vlsiModel_fadd_32cud_U114->dout(grp_fu_137_p2);
    vlsiModel_fmul_32dEe_U115 = new vlsiModel_fmul_32dEe<1,3,32,32,32>("vlsiModel_fmul_32dEe_U115");
    vlsiModel_fmul_32dEe_U115->clk(ap_clk);
    vlsiModel_fmul_32dEe_U115->reset(ap_rst);
    vlsiModel_fmul_32dEe_U115->din0(B_load_3_reg_390);
    vlsiModel_fmul_32dEe_U115->din1(B_load_reg_395);
    vlsiModel_fmul_32dEe_U115->ce(ap_var_for_const0);
    vlsiModel_fmul_32dEe_U115->dout(grp_fu_141_p2);
    vlsiModel_mul_64sbkb_U116 = new vlsiModel_mul_64sbkb<1,2,64,64,64>("vlsiModel_mul_64sbkb_U116");
    vlsiModel_mul_64sbkb_U116->clk(ap_clk);
    vlsiModel_mul_64sbkb_U116->reset(ap_rst);
    vlsiModel_mul_64sbkb_U116->din0(outcols);
    vlsiModel_mul_64sbkb_U116->din1(outrows);
    vlsiModel_mul_64sbkb_U116->ce(ap_var_for_const0);
    vlsiModel_mul_64sbkb_U116->dout(grp_fu_145_p2);
    vlsiModel_mul_muleOg_U117 = new vlsiModel_mul_muleOg<1,1,18,18,18>("vlsiModel_mul_muleOg_U117");
    vlsiModel_mul_muleOg_U117->din0(outrowidx_fu_262_p0);
    vlsiModel_mul_muleOg_U117->din1(tmp_22_reg_316);
    vlsiModel_mul_muleOg_U117->dout(outrowidx_fu_262_p2);
    vlsiModel_mul_mulocq_U118 = new vlsiModel_mul_mulocq<1,1,12,12,12>("vlsiModel_mul_mulocq_U118");
    vlsiModel_mul_mulocq_U118->din0(inneridx_fu_267_p0);
    vlsiModel_mul_mulocq_U118->din1(tmp_23_reg_321);
    vlsiModel_mul_mulocq_U118->dout(inneridx_fu_267_p2);
    vlsiModel_mac_mulpcA_U119 = new vlsiModel_mac_mulpcA<1,1,12,12,12,12>("vlsiModel_mac_mulpcA_U119");
    vlsiModel_mac_mulpcA_U119->din0(tmp_28_fu_198_p1);
    vlsiModel_mac_mulpcA_U119->din1(tmp_24_reg_326);
    vlsiModel_mac_mulpcA_U119->din2(tmp_25_reg_331);
    vlsiModel_mac_mulpcA_U119->dout(grp_fu_272_p3);
    ...
    sc_trace(mVcdFile, C_addr_3_reg_385, "C_addr_3_reg_385");
    sc_trace(mVcdFile, B_load_3_reg_390, "B_load_3_reg_390");
    ...
    sc_trace(mVcdFile, tmp_2_reg_410, "tmp_2_reg_410");
...
k2c_matmul_1::~k2c_matmul_1() {
    ...
    delete vlsiModel_fadd_32cud_U114;
    delete vlsiModel_fmul_32dEe_U115;
    delete vlsiModel_mul_64sbkb_U116;
    delete vlsiModel_mul_muleOg_U117;
    delete vlsiModel_mul_mulocq_U118;
    delete vlsiModel_mac_mulpcA_U119;
}
...
void k2c_matmul_1::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && esl_seteq<1,1,1>(exitcond1_fu_202_p2.read(), ap_const_lv1_0))) {
        B_addr_reg_362 =  (sc_lv<11>) (sum_cast_fu_218_p1.read());
        tmp1_reg_367 = grp_fu_272_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        B_load_3_reg_390 = B_q0.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read()) && esl_seteq<1,1,1>(exitcond_fu_231_p2.read(), ap_const_lv1_0))) {
        C_addr_3_reg_385 =  (sc_lv<17>) (sum2_cast_fu_257_p1.read());
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state10.read())) {
        C_load_reg_405 = C_q0.read();
        tmp_1_reg_400 = grp_fu_141_p2.read();
    }
    ...
    if ((esl_seteq<1,1,1>(exitcond3_fu_156_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
        tmp_22_reg_316 = tmp_22_fu_167_p1.read();
        tmp_23_reg_321 = tmp_23_fu_170_p1.read();
        tmp_24_reg_326 = tmp_24_fu_173_p1.read();
        tmp_25_reg_331 = tmp_25_fu_176_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state15.read())) {
        tmp_2_reg_410 = grp_fu_137_p2.read();
    }
...
void k2c_matmul_1::thread_B_address1() {
    B_address1 =  (sc_lv<11>) (sum3_cast_fu_247_p1.read());
}
...
void k2c_matmul_1::thread_C_address0() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state16.read()) || 
        ...
        C_address0 = C_addr_3_reg_385.read();
...
void k2c_matmul_1::thread_a10_fu_161_p2() {
...
void k2c_matmul_1::thread_a_cast_fu_151_p1() {
...
void k2c_matmul_1::thread_ap_CS_fsm_state9() {
...
void k2c_matmul_1::thread_i_4_fu_192_p2() {
...
void k2c_matmul_1::thread_inneridx_fu_267_p0() {
    inneridx_fu_267_p0 = i_reg_104.read().range(12-1, 0);
}

void k2c_matmul_1::thread_j_2_fu_236_p2() {
...
void k2c_matmul_1::thread_k_2_fu_207_p2() {
...
void k2c_matmul_1::thread_outrowidx_fu_262_p0() {
    outrowidx_fu_262_p0 = i_reg_104.read().range(18-1, 0);
}

void k2c_matmul_1::thread_sum2_cast_fu_257_p1() {
    sum2_cast_fu_257_p1 = esl_zext<64,18>(sum2_fu_252_p2.read());
}

void k2c_matmul_1::thread_sum2_fu_252_p2() {
    sum2_fu_252_p2 = (!tmp_29_fu_223_p1.read().is_01() || !outrowidx_reg_344.read().is_01())? sc_lv<18>(): (sc_biguint<18>(tmp_29_fu_223_p1.read()) + sc_bigint<18>(outrowidx_reg_344.read()));
}

void k2c_matmul_1::thread_sum3_cast_fu_247_p1() {
    sum3_cast_fu_247_p1 = esl_zext<64,12>(sum3_fu_242_p2.read());
}

void k2c_matmul_1::thread_sum3_fu_242_p2() {
    sum3_fu_242_p2 = (!tmp1_reg_367.read().is_01() || !tmp_30_fu_227_p1.read().is_01())? sc_lv<12>(): (sc_bigint<12>(tmp1_reg_367.read()) + sc_biguint<12>(tmp_30_fu_227_p1.read()));
}

void k2c_matmul_1::thread_sum_cast_fu_218_p1() {
    sum_cast_fu_218_p1 = esl_zext<64,12>(sum_fu_213_p2.read());
}

void k2c_matmul_1::thread_sum_fu_213_p2() {
    sum_fu_213_p2 = (!tmp_28_fu_198_p1.read().is_01() || !inneridx_reg_349.read().is_01())? sc_lv<12>(): (sc_bigint<12>(tmp_28_fu_198_p1.read()) + sc_bigint<12>(inneridx_reg_349.read()));
}
...
void k2c_matmul_1::thread_tmp_22_fu_167_p1() {
    tmp_22_fu_167_p1 = tmp_22_fu_167_p0.read().range(18-1, 0);
}

void k2c_matmul_1::thread_tmp_23_fu_170_p1() {
    tmp_23_fu_170_p1 = innerdim.read().range(12-1, 0);
}
...
void k2c_matmul_1::thread_tmp_24_fu_173_p1() {
    tmp_24_fu_173_p1 = tmp_24_fu_173_p0.read().range(12-1, 0);
}

void k2c_matmul_1::thread_tmp_25_fu_176_p1() {
    tmp_25_fu_176_p1 = B_offset.read().range(12-1, 0);
}

void k2c_matmul_1::thread_tmp_28_fu_198_p1() {
    tmp_28_fu_198_p1 = k_reg_115.read().range(12-1, 0);
}

void k2c_matmul_1::thread_tmp_29_fu_223_p1() {
    tmp_29_fu_223_p1 = j_reg_126.read().range(18-1, 0);
}

void k2c_matmul_1::thread_tmp_30_fu_227_p1() {
    tmp_30_fu_227_p1 = j_reg_126.read().range(12-1, 0);
}
