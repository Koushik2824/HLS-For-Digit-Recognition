...
#ifndef __vlsiModel_urem_64jbC__HH__
#define __vlsiModel_urem_64jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_urem_64jbC) {
    ...
    SC_CTOR(vlsiModel_urem_64jbC):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
