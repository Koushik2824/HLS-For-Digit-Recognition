...
#ifndef __vlsiModel_mac_mulsc4__HH__
#define __vlsiModel_mac_mulsc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mac_mulsc4) {
    ...
    SC_CTOR(vlsiModel_mac_mulsc4):  simcore_mac_3_U ("simcore_mac_3_U") {
