...
#ifndef __vlsiModel_dense_2KfY_H__
#define __vlsiModel_dense_2KfY_H__
...
struct vlsiModel_dense_2KfY_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(vlsiModel_dense_2KfY_ram) {
...
SC_MODULE(vlsiModel_dense_2KfY) {
...
vlsiModel_dense_2KfY_ram* meminst;


SC_CTOR(vlsiModel_dense_2KfY) {
meminst = new vlsiModel_dense_2KfY_ram("vlsiModel_dense_2KfY_ram");
