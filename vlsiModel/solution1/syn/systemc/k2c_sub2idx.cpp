...
k2c_sub2idx::k2c_sub2idx(sc_module_name name) : sc_module(name), mVcdFile(0) {
    vlsiModel_mul_64sbkb_U1 = new vlsiModel_mul_64sbkb<1,2,64,64,64>("vlsiModel_mul_64sbkb_U1");
    vlsiModel_mul_64sbkb_U1->clk(ap_clk);
    vlsiModel_mul_64sbkb_U1->reset(ap_rst);
    vlsiModel_mul_64sbkb_U1->din0(shape_load_reg_188);
    vlsiModel_mul_64sbkb_U1->din1(temp1_reg_71);
    vlsiModel_mul_64sbkb_U1->ce(ap_var_for_const0);
    vlsiModel_mul_64sbkb_U1->dout(grp_fu_132_p2);
...
k2c_sub2idx::~k2c_sub2idx() {
    ...
    delete vlsiModel_mul_64sbkb_U1;
}
