...
#ifndef __vlsiModel_faddfsuFfa__HH__
#define __vlsiModel_faddfsuFfa__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_faddfsuFfa) {
    ...
    SC_CTOR(vlsiModel_faddfsuFfa):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
