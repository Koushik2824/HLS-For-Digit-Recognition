...
#ifndef __vlsiModel_mul_mulBew__HH__
#define __vlsiModel_mul_mulBew__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mul_mulBew) {
    ...
    SC_CTOR(vlsiModel_mul_mulBew):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
