...
#ifndef __vlsiModel_mul_mulocq__HH__
#define __vlsiModel_mul_mulocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(vlsiModel_mul_mulocq) {
    ...
    SC_CTOR(vlsiModel_mul_mulocq):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
