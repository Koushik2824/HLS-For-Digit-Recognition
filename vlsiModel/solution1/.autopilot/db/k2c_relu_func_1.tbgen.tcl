set moduleName k2c_relu_func_1
...
set C_modelName {k2c_relu_func.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ x float 32 regular {array 25 { 2 3 } 1 1 }  }
	{ size int 64 regular  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_fcmp_32lbW_U156", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 5 }  { x_ce0 mem_ce 1 1 }  { x_we0 mem_we 1 1 }  { x_d0 mem_din 1 32 }  { x_q0 mem_dout 0 32 } } }
