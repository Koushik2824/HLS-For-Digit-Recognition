...
set C_modelArgList {
	{ C float 32 regular {array 100 { 2 3 } 1 1 }  }
	{ A float 32 regular {array 79184 { 1 1 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_mac_mulfYi_U10", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	A { ap_memory {  { A_address0 mem_address 1 17 }  { A_ce0 mem_ce 1 1 }  { A_q0 mem_dout 0 32 }  { A_address1 mem_address 1 17 }  { A_ce1 mem_ce 1 1 }  { A_q1 mem_dout 0 32 } } }
