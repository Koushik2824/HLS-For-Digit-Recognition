...
set C_modelArgList {
	...
	{ B float 32 regular {array 1300 { 1 1 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_fadd_32cud_U114", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_fmul_32dEe_U115", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_mul_64sbkb_U116", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_mul_muleOg_U117", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_mul_mulocq_U118", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_mac_mulpcA_U119", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	B { ap_memory {  { B_address0 mem_address 1 11 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 32 }  { B_address1 mem_address 1 11 }  { B_ce1 mem_ce 1 1 }  { B_q1 mem_dout 0 32 } } }
