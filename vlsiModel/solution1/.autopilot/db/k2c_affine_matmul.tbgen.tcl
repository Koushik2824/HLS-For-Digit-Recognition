...
set C_modelArgList {
	{ C float 32 regular {array 50 { 2 3 } 1 1 }  }
	{ A float 32 regular {array 100 { 1 3 } 1 1 }  }
	{ B float 32 regular {array 5000 { 1 3 } 1 1 }  }
	{ d float 32 regular {array 50 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ d_address0 sc_out sc_lv 6 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "d_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "d", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_fadd_32cud_U101", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_fmul_32dEe_U102", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_mul_64sbkb_U103", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_mac_mulqcK_U104", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	d { ap_memory {  { d_address0 mem_address 1 6 }  { d_ce0 mem_ce 1 1 }  { d_q0 mem_dout 0 32 } } }
