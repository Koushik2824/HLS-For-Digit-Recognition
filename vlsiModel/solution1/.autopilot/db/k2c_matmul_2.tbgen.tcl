...
set C_modelArgList {
	{ C float 32 regular {array 25 { 2 3 } 1 1 }  }
	{ A float 32 regular {array 1300 { 1 1 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_fadd_32cud_U126", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_fmul_32dEe_U127", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_mul_64sbkb_U128", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_mul_mulvdy_U129", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vlsiModel_mac_mulwdI_U130", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	C { ap_memory {  { C_address0 mem_address 1 5 }  { C_ce0 mem_ce 1 1 }  { C_we0 mem_we 1 1 }  { C_d0 mem_din 1 32 }  { C_q0 mem_dout 0 32 } } }
	A { ap_memory {  { A_address0 mem_address 1 11 }  { A_ce0 mem_ce 1 1 }  { A_q0 mem_dout 0 32 }  { A_address1 mem_address 1 11 }  { A_ce1 mem_ce 1 1 }  { A_q1 mem_dout 0 32 } } }
