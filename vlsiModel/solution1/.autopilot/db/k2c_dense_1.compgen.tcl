...
set ID 238
set hasByteEnable 0
set MemName k2c_dense_1_denseJfO
...
set ID 239
set hasByteEnable 0
set MemName k2c_dense_1_denseKfY
set CoreName ap_simcore_mem
set PortList { 1 3 }
set DataWd 32
set AddrRange 10
...
set TrueReset 0
set IsROM 1
set ROMData { "10111101101110100001010101111011" "10111101000100100010011001000011" "10111100100001111001011001011100" "10111101010110010011111001001001" "10111011100001110011011010110010" "00111101111100111111101010110100" "10111101110110111101000010000001" "10111100100010110111101001011100" "00111101100101001100001101100111" "00111100100111111010110011100011" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { output_array_address0 { O 4 vector } output_array_ce0 { O 1 bit } output_array_we0 { O 1 bit } output_array_d0 { O 32 vector } output_array_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename dense_2_output_array \
    op interface \
    ports { dense_2_output_array_address0 { O 5 vector } dense_2_output_array_ce0 { O 1 bit } dense_2_output_array_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'dense_2_output_array'"
}
}
