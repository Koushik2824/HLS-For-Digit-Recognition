...
reg   [10:0] dense_2_fwork_address0;
...
wire   [63:0] i_43_fu_629_p2;
wire    ap_CS_fsm_state2;
wire   [63:0] i_44_fu_665_p2;
...
wire   [0:0] tmp_1_fu_752_p2;
wire   [2:0] i_48_fu_763_p2;
reg   [2:0] i_48_reg_1101;
wire   [63:0] i_8_cast_fu_769_p1;
reg   [63:0] i_8_cast_reg_1106;
wire    ap_CS_fsm_state77;
wire   [2:0] i_49_fu_779_p2;
reg   [2:0] i_49_reg_1114;
wire   [0:0] exitcond4_fu_774_p2;
wire    ap_CS_fsm_state78;
wire   [63:0] i_9_cast_fu_785_p1;
reg   [63:0] i_9_cast_reg_1129;
wire    ap_CS_fsm_state80;
wire   [2:0] i_50_fu_795_p2;
reg   [2:0] i_50_reg_1137;
wire   [0:0] exitcond9_fu_790_p2;
wire   [31:0] tmp_54_fu_801_p1;
reg   [31:0] tmp_54_reg_1147;
wire    ap_CS_fsm_state81;
wire   [63:0] i_51_fu_809_p2;
reg   [63:0] i_51_reg_1160;
wire    ap_CS_fsm_state83;
wire   [31:0] tmp_55_fu_815_p1;
reg   [31:0] tmp_55_reg_1165;
wire   [0:0] exitcond5_fu_804_p2;
wire   [11:0] tmp_56_fu_818_p1;
reg   [11:0] tmp_56_reg_1170;
wire   [31:0] i_23_fu_821_p2;
reg   [31:0] i_23_reg_1175;
wire    ap_CS_fsm_state84;
wire   [63:0] tmp_15_i_fu_835_p1;
reg   [63:0] tmp_15_i_reg_1183;
wire   [0:0] tmp_57_fu_827_p3;
...
wire   [63:0] i_22_fu_874_p2;
reg   [63:0] i_22_reg_1235;
wire    ap_CS_fsm_state157;
wire   [31:0] i_24_fu_880_p2;
reg   [31:0] i_24_reg_1240;
wire    ap_CS_fsm_state158;
wire   [63:0] tmp_15_i6_fu_894_p1;
reg   [63:0] tmp_15_i6_reg_1248;
wire   [0:0] tmp_58_fu_886_p3;
wire   [63:0] grp_fu_906_p2;
wire    ap_CS_fsm_state226;
wire   [63:0] j_5_cast_fu_912_p1;
reg   [63:0] j_5_cast_reg_1263;
wire    ap_CS_fsm_state227;
wire   [2:0] j_10_fu_922_p2;
reg   [2:0] j_10_reg_1271;
...
wire   [2:0] tmp_53_fu_702_p1;
wire   [11:0] tmp_59_fu_928_p1;
wire   [11:0] sum_fu_932_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond2_fu_869_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state157))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_9_fu_635_p2 == 1'd0) & (exitcond_fu_624_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond2_fu_869_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state157))) begin
        i_0_in_i3_reg_575 <= tmp_55_reg_1165;
    end else if ((1'b1 == ap_CS_fsm_state226)) begin
        i_0_in_i3_reg_575 <= i_24_reg_1240;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond5_fu_804_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state83))) begin
        i_0_in_i_reg_531 <= tmp_54_reg_1147;
    end else if ((1'b1 == ap_CS_fsm_state152)) begin
        i_0_in_i_reg_531 <= i_23_reg_1175;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond1_fu_660_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        i_1_reg_430 <= i_44_fu_665_p2;
    end else if (((exitcond_fu_624_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        i_1_reg_430 <= 64'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_s_fu_737_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state74))) begin
        ...
        i_7_reg_462 <= i_48_reg_1101;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_1_fu_752_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state75))) begin
        i_8_reg_485 <= 3'd0;
    end else if ((1'b1 == ap_CS_fsm_state79)) begin
        i_8_reg_485 <= i_49_reg_1114;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond4_fu_774_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state77))) begin
        i_9_reg_496 <= 3'd0;
    end else if ((1'b1 == ap_CS_fsm_state82)) begin
        i_9_reg_496 <= i_50_reg_1137;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_fu_624_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        i_reg_418 <= i_43_fu_629_p2;
    end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        i_reg_418 <= 64'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond9_fu_790_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state80))) begin
        idx2_8_reg_507 <= 64'd0;
    end else if (((grp_k2c_sub2idx_fu_607_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state156))) begin
        idx2_8_reg_507 <= i_51_reg_1160;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond5_fu_804_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state83))) begin
        idx2_9_reg_551 <= 64'd0;
    end else if (((grp_k2c_sub2idx_fu_607_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state230))) begin
        idx2_9_reg_551 <= i_22_reg_1235;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond2_fu_869_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state157))) begin
        idx2_i2_reg_564 <= idx2_9_reg_551;
    end else if ((1'b1 == ap_CS_fsm_state226)) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_57_fu_827_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state84))) begin
        j_4_reg_540 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_58_fu_886_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state158))) begin
        j_5_reg_584 <= 3'd0;
    end else if ((1'b1 == ap_CS_fsm_state229)) begin
        j_5_reg_584 <= j_10_reg_1271;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state71)) begin
        ...
        i_45_reg_1047 <= i_45_fu_705_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state157)) begin
        i_22_reg_1235 <= i_22_fu_874_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state84)) begin
        i_23_reg_1175 <= i_23_fu_821_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state158)) begin
        i_24_reg_1240 <= i_24_fu_880_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state72)) begin
        i_46_reg_1065 <= i_46_fu_726_p2;
        i_4_cast_reg_1057[2 : 0] <= i_4_cast_fu_716_p1[2 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_1_fu_752_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state75))) begin
        i_48_reg_1101 <= i_48_fu_763_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state77)) begin
        i_49_reg_1114 <= i_49_fu_779_p2;
...
always @ (posedge ap_clk) begin
    if (((tmp_58_fu_886_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state158))) begin
        tmp_15_i6_reg_1248[31 : 0] <= tmp_15_i6_fu_894_p1[31 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_57_fu_827_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state84))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond9_fu_790_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state80))) begin
        tmp_54_reg_1147 <= tmp_54_fu_801_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond5_fu_804_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state83))) begin
        tmp_55_reg_1165 <= tmp_55_fu_815_p1;
        tmp_56_reg_1170 <= tmp_56_fu_818_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state230)) begin
        dense_2_fwork_address0 = sum_cast_fu_937_p1;
    end else if ((1'b1 == ap_CS_fsm_state156)) begin
        dense_2_fwork_address0 = grp_k2c_sub2idx_fu_607_ap_return;
    end else if ((1'b1 == ap_CS_fsm_state231)) begin
        dense_2_fwork_address0 = grp_k2c_matmul_1_fu_595_B_address0;
    end else begin
...
always @ (*) begin
    if ((((grp_k2c_sub2idx_fu_607_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state230)) | ((grp_k2c_sub2idx_fu_607_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state156)))) begin
        ...
        dense_2_fwork_ce0 = grp_k2c_matmul_1_fu_595_B_ce0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state231)) begin
        dense_2_fwork_ce1 = grp_k2c_matmul_1_fu_595_B_ce1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state230)) begin
        dense_2_fwork_d0 = B_array_q0;
    end else if ((1'b1 == ap_CS_fsm_state156)) begin
        dense_2_fwork_d0 = A_array_q0;
    end else begin
        dense_2_fwork_d0 = 'bx;
    end
end
...
assign A_array_address0 = idx2_8_reg_507;

assign B_array_address0 = idx2_9_reg_551;
...
assign exitcond2_fu_869_p2 = ((idx2_9_reg_551 == B_numel_read) ? 1'b1 : 1'b0);

assign exitcond4_fu_774_p2 = ((i_8_cast_fu_769_p1 == A_ndim_read) ? 1'b1 : 1'b0);

assign exitcond5_fu_804_p2 = ((idx2_8_reg_507 == A_numel_read) ? 1'b1 : 1'b0);

assign exitcond6_fu_721_p2 = ((i_4_cast_fu_716_p1 == i_45_reg_1047) ? 1'b1 : 1'b0);
...
assign i_14_cast_fu_710_p2 = ($signed(3'd7) + $signed(tmp_53_fu_702_p1));

assign i_22_fu_874_p2 = (idx2_9_reg_551 + 64'd1);

assign i_23_fu_821_p2 = ($signed(i_0_in_i_reg_531) + $signed(32'd4294967295));

assign i_24_fu_880_p2 = ($signed(i_0_in_i3_reg_575) + $signed(32'd4294967295));

assign i_43_fu_629_p2 = (i_reg_418 + 64'd1);

assign i_44_fu_665_p2 = (i_1_reg_430 + 64'd1);

assign i_45_fu_705_p2 = ($signed(64'd18446744073709551615) + $signed(A_ndim_read));

assign i_46_fu_726_p2 = (i_4_reg_442 + 3'd1);

assign i_47_fu_742_p2 = (i_5_reg_453 + 3'd1);

assign i_48_fu_763_p2 = (i_7_reg_462 + 3'd1);

assign i_49_fu_779_p2 = (i_8_reg_485 + 3'd1);

assign i_4_cast_fu_716_p1 = i_4_reg_442;

assign i_50_fu_795_p2 = (i_9_reg_496 + 3'd1);

assign i_51_fu_809_p2 = (idx2_8_reg_507 + 64'd1);
...
assign j_10_fu_922_p2 = (j_5_reg_584 + 3'd1);
...
assign sum_fu_932_p2 = (tmp_59_fu_928_p1 + tmp_56_reg_1170);

assign tmp_15_i6_fu_894_p1 = i_24_fu_880_p2;

assign tmp_15_i_fu_835_p1 = i_23_fu_821_p2;

assign tmp_1_fu_752_p2 = ((i_7_cast_fu_748_p1 < B_ndim_read) ? 1'b1 : 1'b0);

assign tmp_53_fu_702_p1 = A_ndim_read[2:0];

assign tmp_54_fu_801_p1 = A_ndim_read[31:0];

assign tmp_55_fu_815_p1 = B_ndim_read[31:0];

assign tmp_56_fu_818_p1 = A_numel_read[11:0];

assign tmp_57_fu_827_p3 = i_23_fu_821_p2[32'd31];

assign tmp_58_fu_886_p3 = i_24_fu_880_p2[32'd31];

assign tmp_59_fu_928_p1 = grp_k2c_sub2idx_fu_607_ap_return[11:0];

assign tmp_9_fu_635_p2 = ((i_reg_418 == p_read4) ? 1'b1 : 1'b0);
