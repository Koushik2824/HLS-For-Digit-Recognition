...
always @ (*) begin
    if (((tmp_3_fu_105_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        x_we0 = 1'b1;
    end else begin
        x_we0 = 1'b0;
    end
...
assign notrhs_fu_95_p2 = ((tmp_14_fu_85_p1 == 23'd0) ? 1'b1 : 1'b0);

assign tmp_14_fu_85_p1 = x_load_to_int_fu_71_p1[22:0];

assign tmp_3_fu_105_p2 = (tmp_s_fu_101_p2 & tmp_2_reg_138);
