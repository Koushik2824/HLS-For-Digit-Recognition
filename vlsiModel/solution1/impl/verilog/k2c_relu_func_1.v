...
reg   [63:0] i_3_reg_121;
wire    ap_CS_fsm_state2;
reg   [4:0] x_addr_reg_126;
...
always @ (*) begin
    if (((tmp_5_fu_107_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        x_we0 = 1'b1;
    end else begin
        x_we0 = 1'b0;
    end
...
assign notrhs_fu_95_p2 = ((tmp_17_fu_85_p1 == 23'd0) ? 1'b1 : 1'b0);

assign tmp_17_fu_85_p1 = x_load_to_int_fu_71_p1[22:0];

assign tmp_5_fu_107_p2 = (tmp_s_fu_101_p2 & tmp_4_fu_54_p2);

assign tmp_fu_75_p4 = {{x_load_to_int_fu_71_p1[30:23]}};

assign tmp_s_fu_101_p2 = (notrhs_fu_95_p2 | notlhs_fu_89_p2);

assign x_d0 = 32'd0;

assign x_load_to_int_fu_71_p1 = x_q0;

endmodule //k2c_relu_func_1
