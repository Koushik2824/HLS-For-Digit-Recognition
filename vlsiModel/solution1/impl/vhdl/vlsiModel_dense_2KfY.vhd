...
entity vlsiModel_dense_2KfY_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 25
...
architecture rtl of vlsiModel_dense_2KfY_rom is 
...
entity vlsiModel_dense_2KfY is
    generic (
...
architecture arch of vlsiModel_dense_2KfY is
    component vlsiModel_dense_2KfY_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    vlsiModel_dense_2KfY_rom_U :  component vlsiModel_dense_2KfY_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
