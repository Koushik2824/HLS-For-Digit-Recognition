...
entity vlsiModel_dense_1Ffa_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 50
...
architecture rtl of vlsiModel_dense_1Ffa_rom is 
...
entity vlsiModel_dense_1Ffa is
    generic (
...
architecture arch of vlsiModel_dense_1Ffa is
    component vlsiModel_dense_1Ffa_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    vlsiModel_dense_1Ffa_rom_U :  component vlsiModel_dense_1Ffa_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
