...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.vlsiModel.autotvin_dense_input_input_array.dat"
         "c.vlsiModel.autotvin_dense_input_input_ndim.dat"
         "c.vlsiModel.autotvin_dense_input_input_numel.dat"
         "c.vlsiModel.autotvin_dense_input_input_shape.dat"
         "c.vlsiModel.autotvin_dense_3_output_array.dat"
         "c.vlsiModel.autotvout_dense_3_output_array.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.vlsiModel.autotvout_dense_3_output_array.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
