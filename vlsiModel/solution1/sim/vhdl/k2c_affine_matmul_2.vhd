...
architecture behav of k2c_affine_matmul_2 is 
    ...
    signal p_1_fu_182_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_103_fu_188_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_103_reg_328 : STD_LOGIC_VECTOR (4 downto 0);
    signal exitcond3_fu_177_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_104_fu_191_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_104_reg_333 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_105_fu_194_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_105_reg_338 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_65_fu_210_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_65_reg_346 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal outrowidx_fu_216_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal outrowidx_reg_351 : STD_LOGIC_VECTOR (4 downto 0);
    signal exitcond2_fu_205_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal inneridx_fu_221_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal inneridx_reg_356 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_108_fu_226_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_108_reg_361 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal j_13_fu_239_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal j_13_reg_369 : STD_LOGIC_VECTOR (63 downto 0);
    signal C_addr_6_reg_374 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal tmp_4_reg_412 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state10 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state10 : signal is "none";
    signal p_reg_104 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal tmp_103_fu_188_p0 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_105_fu_194_p0 : STD_LOGIC_VECTOR (63 downto 0);
    signal exitcond2_fu_205_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_107_fu_201_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_106_fu_197_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal exitcond1_fu_234_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_109_fu_230_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal sum2_fu_245_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_111_fu_259_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal sum5_fu_274_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal grp_fu_288_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_fu_288_p0 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    component vlsiModel_mac_mulIfE IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    vlsiModel_fadd_32cud_U224 : component vlsiModel_fadd_32cud
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    vlsiModel_fmul_32dEe_U225 : component vlsiModel_fmul_32dEe
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    vlsiModel_mul_64sbkb_U226 : component vlsiModel_mul_64sbkb
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    vlsiModel_mac_mulIfE_U227 : component vlsiModel_mac_mulIfE
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 9,
    ...
    port map (
        din0 => grp_fu_288_p0,
        din1 => tmp_105_reg_338,
        din2 => tmp_108_reg_361,
        dout => grp_fu_288_p3);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state5) and (exitcond1_fu_234_p2 = ap_const_lv1_0))) then
                C_addr_6_reg_374 <= sum2_cast_fu_250_p1(4 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                j_13_reg_369 <= j_13_fu_239_p2;
                tmp_108_reg_361 <= tmp_108_fu_226_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (exitcond3_fu_177_p2 = ap_const_lv1_1))) then
                tmp_103_reg_328 <= tmp_103_fu_188_p1;
                tmp_104_reg_333 <= tmp_104_fu_191_p1;
                tmp_105_reg_338 <= tmp_105_fu_194_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    A_address0 <= sum5_cast_fu_279_p1(5 - 1 downto 0);
    ...
    B_address0 <= sum8_cast_fu_284_p1(8 - 1 downto 0);
    ...
    C_address0_assign_proc : process(ap_CS_fsm_state3, C_addr_6_reg_374, ap_CS_fsm_state6, ap_CS_fsm_state10, ap_CS_fsm_state20, ap_CS_fsm_state15, p_cast_fu_172_p1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state15) or (ap_const_logic_1 = ap_CS_fsm_state20) or (ap_const_logic_1 = ap_CS_fsm_state10) or (ap_const_logic_1 = ap_CS_fsm_state6))) then 
            C_address0 <= C_addr_6_reg_374;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            C_address0 <= p_cast_fu_172_p1(4 - 1 downto 0);
        else 
            C_address0 <= "XXXX";
        end if; 
    end process;
    ...
    d_address0 <= j_reg_126(4 - 1 downto 0);
    ...
    grp_fu_150_p1_assign_proc : process(d_q0, ap_CS_fsm_state11, ap_CS_fsm_state16, tmp_4_reg_412)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state16)) then 
            grp_fu_150_p1 <= d_q0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            grp_fu_150_p1 <= tmp_4_reg_412;
        else 
            grp_fu_150_p1 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    end process;

    grp_fu_288_p0 <= k_reg_139(9 - 1 downto 0);
    i_65_fu_210_p2 <= std_logic_vector(unsigned(ap_const_lv64_1) + unsigned(i_reg_115));
    inneridx_fu_221_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(tmp_106_fu_197_p1) * signed(tmp_104_reg_333))), 6));
    j_13_fu_239_p2 <= std_logic_vector(unsigned(ap_const_lv64_1) + unsigned(j_reg_126));
    k_3_fu_268_p2 <= std_logic_vector(unsigned(ap_const_lv64_1) + unsigned(k_reg_139));
    outrowidx_fu_216_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(tmp_107_fu_201_p1) * signed(tmp_103_reg_328))), 5));
    p_1_fu_182_p2 <= std_logic_vector(unsigned(p_reg_104) + unsigned(ap_const_lv4_1));
    ...
    sum2_fu_245_p2 <= std_logic_vector(unsigned(tmp_109_fu_230_p1) + unsigned(outrowidx_reg_351));
    sum5_cast_fu_279_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum5_fu_274_p2),64));
    sum5_fu_274_p2 <= std_logic_vector(unsigned(tmp_111_fu_259_p1) + unsigned(inneridx_reg_356));
    sum8_cast_fu_284_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_fu_288_p3),64));
    tmp_103_fu_188_p0 <= outcols;
    tmp_103_fu_188_p1 <= tmp_103_fu_188_p0(5 - 1 downto 0);
    tmp_104_fu_191_p1 <= innerdim(6 - 1 downto 0);
    tmp_105_fu_194_p0 <= outcols;
    tmp_105_fu_194_p1 <= tmp_105_fu_194_p0(9 - 1 downto 0);
    tmp_106_fu_197_p1 <= i_reg_115(6 - 1 downto 0);
    tmp_107_fu_201_p1 <= i_reg_115(5 - 1 downto 0);
    tmp_108_fu_226_p1 <= j_reg_126(9 - 1 downto 0);
    tmp_109_fu_230_p1 <= j_reg_126(5 - 1 downto 0);
    tmp_111_fu_259_p1 <= k_reg_139(6 - 1 downto 0);
end behav;
