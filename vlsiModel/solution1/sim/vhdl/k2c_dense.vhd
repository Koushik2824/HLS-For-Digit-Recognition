...
architecture behav of k2c_dense is 
    ...
    signal tmp_8_fu_209_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_8_reg_308 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal dense_output_array_a_reg_349 : STD_LOGIC_VECTOR (6 downto 0);
    signal i_fu_277_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal dense_bias_array_loa_reg_359 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal dense_output_array_l_reg_364 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_199_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_i_17_reg_369 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_k2c_affine_matmul_3_fu_175_ap_idle : STD_LOGIC;
    signal grp_k2c_affine_matmul_3_fu_175_ap_ready : STD_LOGIC;
    signal grp_k2c_affine_matmul_3_fu_175_ap_done : STD_LOGIC;
    ...
    signal grp_k2c_dot_3_fu_154_C_array_address0 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal grp_k2c_dot_3_fu_154_A_array_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_k2c_dot_3_fu_154_A_array_ce0 : STD_LOGIC;
    signal grp_k2c_affine_matmul_3_fu_175_ap_start : STD_LOGIC;
    signal grp_k2c_affine_matmul_3_fu_175_C_address0 : STD_LOGIC_VECTOR (6 downto 0);
    signal grp_k2c_affine_matmul_3_fu_175_C_ce0 : STD_LOGIC;
    signal grp_k2c_affine_matmul_3_fu_175_C_we0 : STD_LOGIC;
    signal grp_k2c_affine_matmul_3_fu_175_C_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_k2c_affine_matmul_3_fu_175_A_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_k2c_affine_matmul_3_fu_175_A_ce0 : STD_LOGIC;
    signal grp_k2c_affine_matmul_3_fu_175_B_address0 : STD_LOGIC_VECTOR (16 downto 0);
    signal grp_k2c_affine_matmul_3_fu_175_B_ce0 : STD_LOGIC;
    signal grp_k2c_affine_matmul_3_fu_175_d_address0 : STD_LOGIC_VECTOR (6 downto 0);
    signal grp_k2c_affine_matmul_3_fu_175_d_ce0 : STD_LOGIC;
    signal grp_k2c_relu_func_3_fu_191_ap_start : STD_LOGIC;
    signal grp_k2c_relu_func_3_fu_191_ap_done : STD_LOGIC;
    signal grp_k2c_relu_func_3_fu_191_ap_idle : STD_LOGIC;
    signal grp_k2c_relu_func_3_fu_191_ap_ready : STD_LOGIC;
    signal grp_k2c_relu_func_3_fu_191_x_address0 : STD_LOGIC_VECTOR (6 downto 0);
    signal grp_k2c_relu_func_3_fu_191_x_ce0 : STD_LOGIC;
    signal grp_k2c_relu_func_3_fu_191_x_we0 : STD_LOGIC;
    signal grp_k2c_relu_func_3_fu_191_x_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_k2c_relu_func_3_fu_191_size : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal grp_k2c_affine_matmul_3_fu_175_ap_start_reg : STD_LOGIC := '0';
    signal grp_k2c_relu_func_3_fu_191_ap_start_reg : STD_LOGIC := '0';
    ...
    signal sum_i_cast_fu_272_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal tmp_93_fu_216_p4 : STD_LOGIC_VECTOR (62 downto 0);
    signal i_i_cast1_fu_232_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal j_i_cast_fu_251_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal sum_i_fu_267_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    port (
        ...
        A_array_address0 : OUT STD_LOGIC_VECTOR (9 downto 0);
    ...
    component k2c_dense_dense_kncg IS
    generic (
        DataWidth : INTEGER;
    ...
    component k2c_dense_dense_bocq IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    dense_kernel_array_U : component k2c_dense_dense_kncg
    generic map (
        DataWidth => 32,
        AddressRange => 78400,
        AddressWidth => 17)
    ...
    dense_bias_array_U : component k2c_dense_dense_bocq
    generic map (
        DataWidth => 32,
        AddressRange => 100,
        AddressWidth => 7)
    ...
    grp_k2c_affine_matmul_3_fu_175 : component k2c_affine_matmul_3
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_k2c_relu_func_3_fu_191 : component k2c_relu_func_3
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    vlsiModel_fadd_32cud_U58 : component vlsiModel_fadd_32cud
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    vlsiModel_mul_64sbkb_U59 : component vlsiModel_mul_64sbkb
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    grp_k2c_affine_matmul_3_fu_175_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_k2c_affine_matmul_3_fu_175_ap_ready = ap_const_logic_1)) then 
                    grp_k2c_affine_matmul_3_fu_175_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    grp_k2c_relu_func_3_fu_191_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_k2c_relu_func_3_fu_191_ap_ready = ap_const_logic_1)) then 
                    grp_k2c_relu_func_3_fu_191_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_fu_255_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                dense_output_array_a_reg_349 <= sum_i_cast_fu_272_p1(7 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state15) and (grp_k2c_affine_matmul_3_fu_175_ap_done = ap_const_logic_1))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, tmp_fu_203_p2, ap_CS_fsm_state3, ap_CS_fsm_state4, exitcond_i_fu_255_p2, ap_CS_fsm_state15, grp_k2c_affine_matmul_3_fu_175_ap_done, grp_k2c_dot_3_fu_154_ap_done, grp_k2c_relu_func_3_fu_191_ap_done, ap_CS_fsm_state2, tmp_i_fu_240_p2, ap_CS_fsm_state12, ap_CS_fsm_state17, ap_block_state17_on_subcall_done)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state12 => 
                if (((grp_k2c_relu_func_3_fu_191_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state12))) then
    ...
    ap_block_state17_on_subcall_done_assign_proc : process(tmp_reg_304, grp_k2c_relu_func_3_fu_191_ap_done)
    begin
                ap_block_state17_on_subcall_done <= ((tmp_reg_304 = ap_const_lv1_1) and (grp_k2c_relu_func_3_fu_191_ap_done = ap_const_logic_0));
    end process;
    ...
    dense_bias_array_address0_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state15, grp_k2c_affine_matmul_3_fu_175_d_address0, j_i_cast1_fu_246_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            dense_bias_array_address0 <= j_i_cast1_fu_246_p1(7 - 1 downto 0);
    ...
    dense_bias_array_ce0_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state15, grp_k2c_affine_matmul_3_fu_175_d_ce0)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    dense_kernel_array_address0_assign_proc : process(ap_CS_fsm_state15, grp_k2c_affine_matmul_3_fu_175_B_address0, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            ...
            dense_kernel_array_address0 <= "XXXXXXXXXXXXXXXXX";
        end if; 
    end process;


    dense_kernel_array_ce0_assign_proc : process(ap_CS_fsm_state15, grp_k2c_affine_matmul_3_fu_175_B_ce0, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
    ...
    dense_output_array_address0_assign_proc : process(tmp_reg_304, ap_CS_fsm_state4, dense_output_array_a_reg_349, ap_CS_fsm_state15, grp_k2c_dot_3_fu_154_C_array_address0, grp_k2c_affine_matmul_3_fu_175_C_address0, grp_k2c_relu_func_3_fu_191_x_address0, ap_CS_fsm_state2, ap_CS_fsm_state11, ap_CS_fsm_state12, ap_CS_fsm_state17, sum_i_cast_fu_272_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            dense_output_array_address0 <= dense_output_array_a_reg_349;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            dense_output_array_address0 <= sum_i_cast_fu_272_p1(7 - 1 downto 0);
    ...
    dense_output_array_ce0_assign_proc : process(tmp_reg_304, ap_CS_fsm_state4, ap_CS_fsm_state15, grp_k2c_dot_3_fu_154_C_array_ce0, grp_k2c_affine_matmul_3_fu_175_C_ce0, grp_k2c_relu_func_3_fu_191_x_ce0, ap_CS_fsm_state2, ap_CS_fsm_state11, ap_CS_fsm_state12, ap_CS_fsm_state17)
    begin
    ...
    dense_output_array_d0_assign_proc : process(tmp_reg_304, tmp_i_17_reg_369, ap_CS_fsm_state15, grp_k2c_dot_3_fu_154_C_array_d0, grp_k2c_affine_matmul_3_fu_175_C_d0, grp_k2c_relu_func_3_fu_191_x_d0, ap_CS_fsm_state2, ap_CS_fsm_state11, ap_CS_fsm_state12, ap_CS_fsm_state17)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
    ...
    dense_output_array_we0_assign_proc : process(tmp_reg_304, ap_CS_fsm_state15, grp_k2c_dot_3_fu_154_C_array_we0, grp_k2c_affine_matmul_3_fu_175_C_we0, grp_k2c_relu_func_3_fu_191_x_we0, ap_CS_fsm_state2, ap_CS_fsm_state11, ap_CS_fsm_state12, ap_CS_fsm_state17)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
    ...
    grp_fu_290_ce_assign_proc : process(ap_CS_fsm_state14, ap_CS_fsm_state15, grp_k2c_affine_matmul_3_fu_175_ap_done)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state14) or ((ap_const_logic_1 = ap_CS_fsm_state15) and (grp_k2c_affine_matmul_3_fu_175_ap_done = ap_const_logic_1)))) then 
    ...
    grp_k2c_affine_matmul_3_fu_175_ap_start <= grp_k2c_affine_matmul_3_fu_175_ap_start_reg;
    grp_k2c_dot_3_fu_154_ap_start <= grp_k2c_dot_3_fu_154_ap_start_reg;
    grp_k2c_relu_func_3_fu_191_ap_start <= grp_k2c_relu_func_3_fu_191_ap_start_reg;

    grp_k2c_relu_func_3_fu_191_size_assign_proc : process(tmp_reg_304, outsize_reg_396, ap_CS_fsm_state12, ap_CS_fsm_state17)
    begin
        if (((tmp_reg_304 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state17))) then 
            ...
            grp_k2c_relu_func_3_fu_191_size <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    end process;
    ...
    icmp_fu_226_p2 <= "0" when (tmp_93_fu_216_p4 = ap_const_lv63_0) else "1";

    input_array_address0_assign_proc : process(ap_CS_fsm_state15, grp_k2c_dot_3_fu_154_A_array_address0, grp_k2c_affine_matmul_3_fu_175_A_address0, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            ...
            input_array_address0 <= "XXXXXXXXXX";
        end if; 
    end process;


    input_array_ce0_assign_proc : process(ap_CS_fsm_state15, grp_k2c_dot_3_fu_154_A_array_ce0, grp_k2c_affine_matmul_3_fu_175_A_ce0, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
    ...
    outrows1_fu_283_p3 <= 
        ...
        ap_const_lv64_1;
    sum_i_cast_fu_272_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_i_fu_267_p2),64));
    sum_i_fu_267_p2 <= std_logic_vector(unsigned(j_i_cast_fu_251_p1) + unsigned(i_i_cast_reg_328));
    tmp_8_fu_209_p2 <= std_logic_vector(unsigned(input_ndim_read) + unsigned(ap_const_lv64_FFFFFFFFFFFFFFFF));
    tmp_93_fu_216_p4 <= input_ndim_read(63 downto 1);
