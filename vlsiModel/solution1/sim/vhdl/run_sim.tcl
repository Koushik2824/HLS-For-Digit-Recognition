...
if {[file isfile vlsiModel.autotvin.dat]} {
	file delete -force vlsiModel.autotvin.dat
}

if {[file isfile vlsiModel.autotvout.dat]} {
	file delete -force vlsiModel.autotvout.dat
}
