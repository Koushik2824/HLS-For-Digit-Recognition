...
$(ObjDir)/vlsiModel_test_suite.c_pre.c.tb.o : vlsiModel_test_suite.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) vlsiModel_test_suite.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/vlsiModel.c_pre.c.tb.o : vlsiModel.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) vlsiModel.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
